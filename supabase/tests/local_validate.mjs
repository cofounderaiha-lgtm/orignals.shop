...
const migFile = (n) => {
  const map = {'0001':'0001_admin_bootstrap_secret','0002':'0002_shop_upsert_rpc','0003':'0003_orders_snapshots_rpc',
   ...
   '0024':'0024_catalog_variants_discounts','0025':'0025_double_entry_ledger','0026':'0026_inventory_reservations','0027':'0027_order_full','0028':'0028_serviceability','0029':'0029_notifications'};
