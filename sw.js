...
const SHELL = [
  ...
  './js/send.js', './js/rides.js', './js/tickets.js', './js/estate.js', './js/services.js', './js/supply.js',
  './js/earn.js', './js/myshop.js', './js/mitra.js', './js/account.js', './js/admin.js', './js/call.js',
  './js/cloud.js', './js/analytics.js', './js/brain.js', './js/brain_ml.js', './js/langs.js', './js/cortex.js', './js/memory.js', './js/reason.js', './js/agents.js', './js/geo.js', './js/ops.js', './js/auth.js', './js/face.js', './js/legal.js',
